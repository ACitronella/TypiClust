...
def main(cfg):
    ...
    lSet_path, uSet_path = data_obj.makeLUSetsByNumberOfEyes(2, train_data, cfg.EXP_DIR)
    ...
    lSet, uSet = data_obj.loadLUPartitions(lSetPath=cfg.ACTIVE_LEARNING.LSET_PATH, uSetPath=cfg.ACTIVE_LEARNING.USET_PATH)
    ...
    logger.info("Labeled Set: {}, Unlabeled Set: {}\n".format(len(lSet), len(uSet)))
