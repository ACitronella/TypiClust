...
class EmbeddingDifferenceAsProbabilityDensityWithSoftmax:
    def __init__(self, cfg, lSet, uSet, budgetSize, embedding_path, dataset_info, kernel_size=11, temperature=0.0001):
        self.cfg = cfg
        ...
        self.tb = np.concatenate(([0], self.tb))
        ...
        for row_idx in self.dataset_info.index:
            ...
            start_idx = self.tb[row_idx]
            end_idx = self.tb[row_idx+1]
