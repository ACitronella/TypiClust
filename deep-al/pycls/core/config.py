...
_C.PRETRAINED_WEIGHTS_EACH_PATIENT = "../model_graveyard_but_leaveoneout/init/{patient_code}/init_best_{n_train}n.pt"
_C.PROGRESSIVE_ADD_IN_LSET = False
...
_C.ACTIVE_LEARNING.PROBCOVER_ITER = 1 # for hybrid (run probcover first)
...
# Accepted Datasets
_C.DATASET.ACCEPTED = ["blinkprogressive", "blinkleaveoneout", "blink_fold0", "blink_fold1", "blink_fold2", "blink_fold3", "blink2_fold0", "blink2_fold1", "blink2_fold2", "blink2_fold3", "blink2_fold4", 'MNIST','SVHN','CIFAR10','CIFAR100','TINYIMAGENET', 'IMBALANCED_CIFAR10', 'IMBALANCED_CIFAR100', 'IMAGENET50', 'IMAGENET100', 'IMAGENET200']
