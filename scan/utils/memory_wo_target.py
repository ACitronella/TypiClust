...
class MemoryBank(object):
    def __init__(self, n, dim, num_classes, temperature, pre_lasts_dim=512):
        self.n = n
        self.dim = dim 
        self.features = torch.FloatTensor(self.n, self.dim)
        self.pre_lasts = torch.FloatTensor(self.n, pre_lasts_dim)
        self.ptr = 0
        self.device = 'cpu'
        self.K = 100
    ...
    def update(self, features, pre_last):
        b = features.size(0)
